...
registerTab('preproduction', {
  ...
  onInit: function() {
    document.getElementById('tab-preproduction').innerHTML =
      '<div class="sched-topbar" style="border-bottom:1px solid var(--border);flex-shrink:0"><div class="sched-topbar-left"><div class="page-title">Pre-Production</div></div></div>' +
