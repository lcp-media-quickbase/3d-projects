...
registerTab('timesheets', {
  ...
  onInit: function() {
    document.getElementById('tab-timesheets').innerHTML =
      '<div class="sched-topbar" style="border-bottom:1px solid var(--border);flex-shrink:0"><div class="sched-topbar-left"><div class="page-title"><span>⏱️</span> Timesheets</div></div></div>' +
